...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Movie[] movies = new Movie[]{
                ...
                new Movie("RENFIELD",
                        "https://images.mymovies.net/images/film/cin/350x522/fid21952.jpg",
                        "16",
                        "Evil doesn't span eternity without a little help. In this modern monster tale of Dracula's loyal servant, Nicholas Hoult stars as Renfield, the tortured aide to history's most narcissistic boss, Dracula (Oscar winner Nicolas Cage).",
                        new String[]{" Awkwafina", "Nicholas Hault", "Nicolas Cage"},
                        (int) (Math.random() * 3),
                        120),

                new Movie("THE POPE'S EXORCIST",
                        "https://images.mymovies.net/images/film/cin/350x522/fid21951.jpg",
                        "16",
                        "Portrayal of a real-life figure Father Gabriele Amorth, a priest who acted as chief exorcist of the Vatican and who performed more than 100,000 exorcisms in his lifetime.",
                        new String[]{"Ruseel Crowe", "Daniel Zovatto", "Franco Nero"},
                        (int) (Math.random() * 16),
                        120)
        };
